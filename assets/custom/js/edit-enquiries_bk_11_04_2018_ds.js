...
jQuery(".send-quote-mail").click(function () {
    ...
    if (movetype == "1" || movetype == "2") {
        if (servicedate == "" || name == "" || email == "" || depositamt == "" || trucks == "" || travelfees == "" || clientrate == "" || fromstate == "" || tostate == "") {
    ...
    if (movetype == "5") {
        if (servicedate == "" || name == "" || email == "" || depositamt == "" || ladiesbook == "" || inisellprice == "" || tostate == "") {
            toastr.error('Please fill required field.');
            return false;
        } else if (servicetime == "" || isNaN(servicetime)) {
            toastr.error("Servicetime field is either blank or No Preference that time you can not send email.");
        ...
        jQuery.ajax({
            ...
            success: function (response) {
                ...
                if (res.error) {
                    ...
                    window.location = BASE_URL + "enquiries/viewEnquiries/" + enid;
