...
class StorageReport extends CI_Controller {
    ...
    public function index() {
        $this->data['title'] = "HS Storage Report";
        $data['js'] = array(
        ...
        $data['jsFooter'] = array(
            'custom/js/form-storagereport.js'
        );
        $data['css'] = array(
        ...
        $this->load->view('storageReport_view.php', $this->data);
    ...
    function viewStorageReport() {
        ...
        $revenueReport = $this->booking_model->storageReportData($data);
        $data['revenueReport'] = $revenueReport;

        if ($revenueReport) {

            $xlspdfData = $this->load->view('reports/storagereportviewer.php', $data, true);
            ...
            if ($_POST['pdforxls'] != "") {
                ...
                if ($_POST['pdforxls'] == "xls") {
                    ...
                    $objPHPExcel->getActiveSheet()->SetCellValue('I1', 'Months In Storage');
                    $objPHPExcel->getActiveSheet()->SetCellValue('J1', 'Total Profit');
                    ...
                    foreach ($revenueReport as $revenueReportKey => $revenueReportValue) {
                        ...
                        if ($state != $revenueReportValue['movingfrom_state']) {
                            ...
                            if ($total_cost > 0) {
                                ...
                                $objPHPExcel->getActiveSheet()->SetCellValue('I' . $rowCount, number_format($subMonthsInStorage, 2));
                                $objPHPExcel->getActiveSheet()->SetCellValue('J' . $rowCount, "$" . number_format($subTotalProfit, 2));
                        ...
                        $totalMonthsCount = getTotalMonths($revenueReportValue['en_servicedate']);
                        ...
                        $sTotalMonths =  $this->getTotalMonths($serdate); 
                        ...
                        $objPHPExcel->getActiveSheet()->SetCellValue('I' . $rowCount, $sTotalMonths);
                        $objPHPExcel->getActiveSheet()->SetCellValue('J' . $rowCount, "$" . ($revenueReportValue['margin'] * $sTotalMonths ));
                    ...
                    $objPHPExcel->getActiveSheet()->SetCellValue('I' . $rowCount, $finalMonthTotal);
                    $objPHPExcel->getActiveSheet()->SetCellValue('J' . $rowCount, "$" . number_format($finalProfitTotal, 2));
    ...
    public function getTotalMonths($sDate){
        $date1 = $sDate;
        $date2 = date('Y-m-d');
