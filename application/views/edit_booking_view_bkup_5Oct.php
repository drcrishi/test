        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content" style="margin-left: 0;">
                ...
                <div class = "row form-horizontal inquiry-form">
                    <?php
                    echo form_open('booking/viewBooking', array('id' => 'booking-form', 'method' => 'post'));
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control" id="enquirymovetype" name="en_movetype">
                                                ...
                                                foreach ($move_type as $mt) {
                                                    ...
                                                    <option value="<?php echo $enquiry[0]['en_movetype']; ?>"
                                                    <?php
...
<!--                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control" id="homeoffice" name="en_home_office">
                                                <option value="">Select</option>
                                                <option value="1" data-item="Home"<?php
                                                if ($enquiry[0]['en_home_office'] == 1) {
                                                    echo "selected";
                                                }
                                                ?> >Home</option>
                                                <option value="2" data-item="Office" <?php
                                                if ($enquiry[0]['en_home_office'] == 2) {
                                                    echo "selected";
                                                }
                                                ?>>Office</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input class="form-control form-control-inline date-picker" id="servicedate" name="en_servicedate" size="16" type="text" value="<?php echo date("d-m-Y", strtotime($enquiry[0]['en_servicedate'])); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-5">Service time</label>
                                        <div class="col-md-7">
                                            <input type="text" id="servicetime" name="en_servicetime" class="form-control" value="<?php echo $enquiry[0]['en_servicetime']; ?>"/></div>
                                    </div>
                                    <div class="form-group">
...
//                                                                                            die;
                                            ...
                                            <input type="text" id="customerId" name="customer_id" class="form-control" value="<?php echo $name1; ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="error"></span>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control phone" name="en_phone" value="<?php echo $enquiry[0]['en_phone']; ?>"></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-5">Email</label>
                                        <span class="error"></span>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control email" name="en_email" value="<?php echo $enquiry[0]['en_email']; ?>"></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            ?>
                                            <input type="hidden" name="contact_id" value="<?php echo $enquiry[0]['contact_id']; ?>">
...
<!--                                            <select class="form-control select2me" id="removalist" name="contact_id"></select>-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error"></span>
                                        <div class="col-md-7">
                                            <textarea class="form-control" name="en_note"><?php echo $enquiry[0]['en_note']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="movingfrompostcode" name="en_movingfrom_postcode" value="<?php echo $enquiry[0]['en_movingfrom_postcode']; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>                            
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control " id="movingfromstate" name="en_movingfrom_state" value="<?php echo $enquiry[0]['en_movingfrom_state']; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>                            
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="movingtopostcode" name="en_movingto_postcode" value="<?php echo $enquiry[0]['en_movingto_postcode']; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>                            
                                    <div class="row">
...
<!--                                                    <input type="text" class="form-control " id="movingtosuburb" name="en_movingto_suburb">-->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control " id="movingtostate" name="en_movingto_state" value="<?php echo $enquiry[0]['en_movingto_state']; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>                            
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" name="en_addpickup_street" value="<?php echo $enquiry[0]["en_addpickup_street"]; ?>"></div>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="addpickuppostcode" name="en_addpickup_postcode" value="<?php echo $enquiry[0]["en_addpickup_postcode"]; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>                            
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control suburb" id="addpickupsuburb" name="en_addpickup_suburb" value="<?php echo $enquiry[0]['en_addpickup_suburb']; ?>">
<!--                                                    <input type="text" class="form-control " name="en_addpickup_suburb">-->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="addpickupstate" name="en_addpickup_state" value="<?php echo $enquiry[0]["en_addpickup_state"]; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>                            
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control " name="en_adddelivery_street" value="<?php echo $enquiry[0]['en_adddelivery_street']; ?>"></div>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="adddeliverypostcode" name="en_adddelivery_postcode" value="<?php echo $enquiry[0]['en_adddelivery_postcode']; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>                            
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control suburb" id="adddeliverysuburb" name="en_adddelivery_suburb" value="<?php echo $enquiry[0]['en_adddelivery_suburb']; ?>">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="adddeliverystate" name="en_adddelivery_state" value="<?php echo $enquiry[0]['en_adddelivery_state']; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>                            
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="error"></span>
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control" id="adddeliverypostcode" name="en_promotional_code" value="<?php echo $enquiry[0]['en_referral_source']; ?>"></div>
                                            </div> 
                                        </div>
                                    </div>   
                                </div>                               
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="porlet-section">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-icon input-icon-sm">
                                                <i class="fa fa-usd"></i>
                                                <input type="text" class="form-control input-sm" id="depositamt" name="en_deposit_amt" value="<?php echo $enquiry[0]['en_deposit_amt']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="error"></span>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="movers" name="en_no_of_movers" value="<?php echo $enquiry[0]['en_no_of_movers']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="error"></span>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="trucks" name="en_no_of_trucks" value="<?php echo $enquiry[0]['en_no_of_trucks']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-icon input-icon-sm">
                                                <i class="fa fa-usd"></i>
                                                <input type="text" class="form-control input-sm" id="travelfee" name="en_travelfee" value="<?php echo $enquiry[0]['en_travelfee']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-icon input-icon-sm">
                                                <i class="fa fa-usd"></i>
                                                <input type="text" class="form-control input-sm" id="clienthourlyrate" name="en_client_hourly_rate" value="<?php echo $enquiry[0]['en_client_hourly_rate']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-icon input-icon-sm">
                                                <i class="fa fa-usd"></i>
                                                <input type="text" class="form-control input-sm" name="en_additional_charges" value="<?php echo $enquiry[0]['en_additional_charges']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-icon input-icon-sm">
                                                <i class="fa fa-usd"></i>
                                                <input type="text" class="form-control input-sm" name="en_total_sellprice" value="<?php echo $enquiry[0]['en_total_sellprice']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-icon input-icon-sm">
                                                <i class="fa fa-usd"></i>
                                                <input type="text" class="form-control input-sm" name="en_total_costprice" value="<?php echo $enquiry[0]['en_total_costprice']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="error"></span>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control " name="en_hireamover_margin" value="<?php echo $enquiry[0]['en_hireamover_margin']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="portlet">
                                ...
                                <div class="porlet-section">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error"></span>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control " name="en_eway_refno" value="<?php echo $enquiry[0]['en_eway_refno']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-6">EFT Received </label>
                                        <div class="col-md-6">
                                            <input class="form-control form-control-inline date-picker" id="eftreceivedon" name="en_eft_receivedon" size="16" type="text" value="<?php echo date("d-m-Y", strtotime($enquiry[0]['en_eft_receivedon'])); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
