                    ...
                    <div class="col-md-12">
                        <div class="portlet light">
                                ...
                                <div class="tab-content">
                                    <!-- PERSONAL INFO TAB -->
                                    <div class="userform">
                                        <?php echo form_open_multipart('EmailConf/add_emaildata', array('id' => 'emailconf-form', 'method' => 'post'));
                                        ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <option value="smtp">smtp</option></select>
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="smtp_port" class="form-control" type="text"> </div>
                                            </div>
                                        </div>
<!--                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="smtp_host" class="form-control" type="text"> </div>
                                            </div>                                                        
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                               ...
                                               <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <option value="QuoteP">QuoteP</option>
                                                    <option value="QuoteLP">QuoteLP</option>
                                                    <option value="FollowupR">FollowupR</option>
                                                    <option value="FollowupP">FollowupP</option>
                                                    <option value="JobSheetR">JobSheetR</option>
                                                    <option value="JobSheetP">JobSheetP</option>
                                                    <option value="JobSheetLP">JobSheetLP</option>
                                                    <option value="BookingConfirmationR">BookingConfirmationR</option>
                                                    <option value="BookingConfirmationP">BookingConfirmationP</option>
                                                    <option value="SendFeedbackR">SendFeedbackR</option>
                                                    <option value="SendFeedbackP">SendFeedbackP</option>
                                                    <option value="SendReminderR">SendReminderR</option>
                                                    <option value="SendReminderP">SendReminderP</option>
                                                    <option value="InvoiceR">InvoiceR</option>
                                                    <option value="InvoiceP">InvoiceP</option>
